...
def test_get_crm_ticket_id():
    order = {
        "parameters": {
            "fulfillment": [
                {"externalId": FulfillmentParametersEnum.CRM_TICKET_ID, "value": "ticket_123"}
            ]
        }
    }
...
def test_set_crm_ticket_id():
    order = {
        "parameters": {
            "fulfillment": [
                {"externalId": FulfillmentParametersEnum.CRM_TICKET_ID, "value": "old_ticket"}
            ]
        }
    }
...
def test_get_termination_parameter_found(mocker):
    mock_get_fulfillment_parameter = mocker.patch(
        ...
        return_value={"externalId": OrderParametersEnum.TERMINATION, "value": "termination_flow"}
    )
    order = {
        "parameters": {
            "fulfillment": [
                {"externalId": OrderParametersEnum.TERMINATION, "value": "termination_flow"}
            ]
        }
    }
