...
def test_aws_client_get_cost_and_usage(config, aws_client_factory, data_aws_cost_and_usage_factory):
...
class TestGetPagedResponse:
    def test_success(self, mocker):
        ...
        assert method_mock.call_args_list == [
            call(MaxResults=2, Type="BILLING"),
            call(MaxResults=2, NextToken="token1", Type="BILLING"),
        ]
    ...
    def test_with_kwargs_none(self, mocker):
        ...
        assert method_mock.call_args_list == [call(MaxResults=5)]
    ...
    def test_empty_initial_response(self, mocker):
        ...
        assert result == []
        assert method_mock.call_args_list == [call(MaxResults=5, Type="BILLING")]
