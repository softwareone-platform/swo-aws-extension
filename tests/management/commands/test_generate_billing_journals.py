...
def test_call_command_wrong_date():
    out = StringIO()
    err = StringIO()
...
def test_call_command_with_one_authorization():
    out = StringIO()
    err = StringIO()
...
def test_call_command_with_multiple_authorization():
    out = StringIO()
    err = StringIO()
...
def test_call_command_with_invalid_authorization():
    out = StringIO()
    err = StringIO()
