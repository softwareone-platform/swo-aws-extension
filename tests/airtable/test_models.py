...
def test_get_master_payer_account_pool_model(base_info):
    ...
    record = master_payer_account_pool(account_id="Account Id",
...
def test_get_pool_notification_model(base_info):
    pool_notification = get_pool_notification_model(base_info)
    record = pool_notification(notification_id=1,
