...
def test_sync_agr_with_specific_ids(
    mpt_client,
    config,
    agreement,
...
def test_sync_agr_aws_exception(
    mocker,
    config,
    mock_send_exception,
    mock_awsclient,
...
def test_sync_agr_no_active_transfer(
    mpt_client,
    config,
    agreement_factory,
    mock_get_agreements_by_query,
...
def test_sync_agr_with_active_transfer(
    mpt_client,
    config,
    agreement,
    mock_get_agreements_by_query,
...
def test_sync_agr_exception_during_sync(
    mpt_client,
    config,
    agreement,
    mock_get_agreements_by_query,
...
def test_get_transfer_for_account_found(mocker, config, mock_awsclient):
    mocker.patch(
...
def test_get_transfer_for_account_not_found(mocker, config, mock_awsclient):
    mocker.patch(
        "swo_aws_extension.swo.mpt.sync.syncer.get_accepted_inbound_responsibility_transfers",
        return_value={
            "225989344502": {
...
def test_terminate_agr_active_subs(mpt_client, agreement_factory, mock_terminate_subscription):
...
def test_terminate_agr_dry_run(mpt_client, agreement_factory, mock_terminate_subscription):
...
def test_sync_transfer_id_dry_run(mpt_client, caplog, agreement_factory, mock_update_agreement):
    agreement = agreement_factory()
    pma_account_id = "PMA-123456"
...
def test_sync_transfer_id_exception(
    mpt_client, mock_send_exception, agreement_factory, mock_update_agreement
):
    agreement = agreement_factory()
    pma_account_id = "PMA-123456"
