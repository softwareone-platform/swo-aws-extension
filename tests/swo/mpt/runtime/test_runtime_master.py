...
def mock_initialize(options, group=None, name=None):
    """
    Mock initialize function for testing.
    """
    pass
...
def test_master_signals_handler(mock_runtime_master_options, settings):
    mock_runtime_master = Master(mock_runtime_master_options, settings=settings, initialize_func=mock_initialize)
