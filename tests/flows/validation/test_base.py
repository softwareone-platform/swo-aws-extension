...
from swo_aws_extension.constants import HTTP_STATUS_INTERNAL_SERVER_ERROR
...
def test_validation_change_order(mocker, mpt_client, order_factory):
    ...
    validate_result = validate_order(mpt_client, context)

    assert validate_result == order
