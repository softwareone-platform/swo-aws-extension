...
def test_fulfill_termination_order(mocker, order_factory):
    mock_terminate = mocker.patch("swo_aws_extension.flows.fulfillment.base.terminate.run")
...
def test_fulfill_unsupported_order_type(mocker, order_factory, caplog):
