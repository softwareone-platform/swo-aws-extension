...
def handshake_data_factory(account_id, state):
    return {
        "Id": f"h-{account_id}",
...
def test_map_handhsakes_account_state():
    ...
    handshakes = [
        {"Id": "h-123", "State": "PENDING", "Parties": [{"Type": "ACCOUNT", "Id": "123456789012"}]},
        {
            "Id": "h-456",
            "State": "ACCEPTED",
    ...
    expected_output = {
        ...
        "987654321098": "ACCEPTED",
        "567890123456": "DECLINED",
    }
...
def test_all_accounts_are_accepted(
    ...
    mock_client.list_handshakes_for_organization.return_value = {
        "Handshakes": [
            handshake_data_factory("111111111111", "ACCEPTED"),
            handshake_data_factory("222222222222", "REQUESTED"),
            handshake_data_factory("444444444444", "REQUESTED"),
        ]
    }
    mock_client.invite_account_to_organization.return_value = handshake_data_factory(
        "333333333333", "REQUESTED"
    )
...
def test_error_handling_for_invite_accounts(
    ...
    mock_client.invite_account_to_organization.side_effect = [
        ...
        handshake_data_factory("333333333333", "REQUESTED"),
    ]
...
def test_await_invitation_link_step_all_accepted(
    ...
    mock_aws.list_handshakes_for_organization.return_value = {
        "Handshakes": [
            handshake_data_factory("111111111111", "ACCEPTED"),
            handshake_data_factory("222222222222", "ACCEPTED"),
            handshake_data_factory("333333333333", "EXPIRED"),
            handshake_data_factory("444444444444", "CANCELLED"),
        ]
    }
    order = order_factory(
        fulfillment_parameters=fulfillment_parameters_factory(phase=PhasesEnum.TRANSFER_ACCOUNT),
...
def test_await_invitation_link_step_await_accepted(
    ...
    assert get_phase(context.order) == PhasesEnum.TRANSFER_ACCOUNT
