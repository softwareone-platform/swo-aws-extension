...
def test_process_creates_ticket_when_missing(
    ...
    assert error.value.template_id == OrderQueryingTemplateEnum.NEW_ACCOUNT_CREATION
...
def test_post_step_updates_phase(
    ...
    assert get_phase(context.order) == PhasesEnum.CREATE_BILLING_TRANSFER_INVITATION
