...
| [Airtable](external/airtable.md) | Per-product Airtable base access | Shared service-account token (workspace-scoped Airtable PAT, provisioned and rotated by DevOps) | [airtable.md](external/airtable.md) |
