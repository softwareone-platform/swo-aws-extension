...
class CreateSubscription(Step):
    def __call__(self, client: MPTClient, context: PurchaseContext, next_step):
        ...
        if context.is_purchase_order() and context.is_type_transfer_with_organization():
            ...
            self.create_subscription_from_account_created(client, context)
    ...
    def create_subscription_from_account_created(self, client, context):
    ...
    def subscription_exist_for_account_id(self, client, context, account_id):
        """
    ...
    def create_subscriptions_from_organization(self, client, context):
        ...
        for account in accounts:
            ...
            if self.subscription_exist_for_account_id(client, context, account_id):
                logger.info(
    ...
    def create_aws_subscription(self, client, context, account_id, account_email, account_name):
        subscription = {
