...
class RQLQuery:
    ...
    def null(self, *, value: bool):
        ...
        Args:
            value (bool): The value to which compare the field.
        """
    ...
    def like(self, value: str):
        ...
        Args:
            value (str): The string value to which compare the field.
        """
        if not isinstance(value, str):
            raise TypeError(f"like operator expects a string, got {type(value).__name__}")
    ...
    def ilike(self, value: str):
        ...
        """
        if not isinstance(value, str):
            raise TypeError(f"ilike operator expects a string, got {type(value).__name__}")
